package me.cchu.mall.search;

import com.alibaba.fastjson.JSON;
import me.cchu.mall.search.bean.Account;
import me.cchu.mall.search.bean.User;
...
//		}
	...
	public void indexTest() throws IOException {
		...
		request.id("2");
		// 第1种方式
//		request.source("userName","cchu","age","20","gender","男");

		// 第2种方式
		User user = new User();
		user.setUserName("cchu");
		user.setAge("20");
		user.setGender("男");
