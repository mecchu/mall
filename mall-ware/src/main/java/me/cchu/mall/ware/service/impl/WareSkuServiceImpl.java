...
import me.cchu.mall.ware.feign.OrderFeignService;
import me.cchu.mall.ware.feign.ProductFeignService;
...
import me.cchu.mall.ware.vo.OrderItemVo;
import me.cchu.mall.ware.vo.OrderVo;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
	...
	public double addStock(Long skuId, Long wareId, Integer skuNum) {
		...
		try {
			...
			System.out.println("me.cchu.mall.ware.service.impl.WareSkuServiceImpl：远程调用出错");
		}
		// 新增操作
